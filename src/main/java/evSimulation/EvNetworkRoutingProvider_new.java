...
public class EvNetworkRoutingProvider_new implements Provider<RoutingModule> {
	private static final Logger log = Logger.getLogger(EvNetworkRoutingProvider_new.class);
...
//	private ElectricFleet electricFleet;	
	 ...
	 * @param mode
	 */
	public EvNetworkRoutingProvider_new(String mode) {
		this(mode, mode);
	}
	 ...
	 * @param routingMode
	 */
	public EvNetworkRoutingProvider_new(String mode, String routingMode) {
		this.mode = mode;
	...
	public RoutingModule get() {
		...
		if (plansCalcRouteConfigGroup.isInsertingAccessEgressWalk()) {
			...
			return new EvNetworkRoutingModule_new(mode, filteredNetwork,
