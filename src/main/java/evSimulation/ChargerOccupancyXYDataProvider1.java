...
public class ChargerOccupancyXYDataProvider1 implements Provider<MobsimListener> {
	private final ChargingInfrastructure chargingInfrastructure;
	private final MatsimServices matsimServices;

	@Inject
	public ChargerOccupancyXYDataProvider1(ChargingInfrastructure chargingInfrastructure,
	...
	public MobsimListener get() {
		XYDataCalculator<Charger> calc = createChargerOccupancyCalculator(chargingInfrastructure, true);
